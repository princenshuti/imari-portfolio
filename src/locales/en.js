...
export default {
  ...
  landing: {
    ...
    hero: {
      eyebrow:        'Wealth + family planning · Built for Rwanda',
      headline_1:     'Your whole financial life,',
      headline_2:     'in one honest picture.',
      sub:            'Imari is a private wealth tracker and household planner for Rwanda. Every account, asset, debt, tax date and family plan in one place — read by an AI advisor that computes each figure and never touches your money.',
      pillar_1_label: 'Wealth',
      pillar_1_line:  'Accounts, assets, debts, RRA tax and your pension — one net-worth figure you can trust.',
      pillar_2_label: 'Family',
      pillar_2_line:  'A weekly scorecard, shared calendar, insurance and documents your household keeps together.',
      pillar_3_label: 'AI advisor',
      pillar_3_line:  'Answers in your language, from your own numbers. Every figure computed, never guessed.',
    ...
    family: {
      eyebrow: 'New · Family',
      title:   'The plan your household actually shares.',
      sub:     'Money is rarely a solo project. Imari now carries the household with it — a weekly scorecard you both tick, the renewals and school dates that matter, and a wish list that answers "can we afford it?" from your real numbers.',
      note:    'Every Sunday evening the advisor writes a short review of your week and e-mails it to both of you.',
    },
    preview: {
      label: 'Net worth',
  ...
  settings: {
    ...
    locale_hint:      'Switches every screen — dashboard, reports, family, and the AI advisor, which also replies in this language.',
  },
};
