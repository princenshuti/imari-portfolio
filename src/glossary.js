...
export const TERMS_BY_INSIGHT = {
  ...
  'maturity-reinvestment': ['idle-cash'],
  'obligation-smoothing':  ['runway', 'savings-rate'],
  'fx-debt-exposure':      ['debt-to-asset', 'real-vs-nominal'],
  'rental-yield-gap':      ['idle-cash', 'cost-basis'],
  'receivable-overdue':    ['liquidity'],
  'pension-contribution-gap': ['replacement-ratio'],
